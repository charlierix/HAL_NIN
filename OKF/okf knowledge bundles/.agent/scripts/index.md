...
| [generate_indexes.py](./generate_indexes.py) | Loop 5 — Index & link | Generates `index.md` files, verifies cross-links, writes `log.md` | **Any** — operates on the generated bundle, not the source |
