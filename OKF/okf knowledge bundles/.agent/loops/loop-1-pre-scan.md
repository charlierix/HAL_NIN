...
3. Run `find <source-dir> -type d` for the directory tree.
4. Write the complete inventory to the output file.
...
**Stop when `scan_inventory.md` is written and contains every file in the source directory.** Do not proceed to concept extraction.
